  ...
  return (
    <div className="box">
      ...
      <p>
        ...
        tot knuffels en mutsen, kleedjes en omslagdoeken. Alle producten op deze
        site zijn voorbeelden van de gehaakte producten die ik al eerder gemaakt
        heb. Alles wordt op bestelling gemaakt en kan dus naar eigen wensen en
        ideeën aangepast worden.
      </p>
      <p>
      ...
      <p>
        ...
        tussen mijn foto's staat, neem even contact op via het contactformulier
        of stuur een mailtje. Dan kijken wij samen verder voor een eventuele
        bestelling.
      </p>
    </div>
  );
